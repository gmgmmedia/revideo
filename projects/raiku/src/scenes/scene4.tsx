...
import { RAIKU, colors, timing, effects, layout, cube, fonts, fontSizes } from '../lib/brand';
...
export default makeScene2D('scene4', function* (view) {
  ...
  // --- Hold for transition ---
  // Total scene duration: 6:20 (6.667 seconds)
  yield* waitFor(1.0);
});
