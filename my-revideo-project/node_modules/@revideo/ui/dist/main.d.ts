...
import { ExporterSettings } from '@revideo/core';
...
import { Player } from '@revideo/core';
...
export declare function AutoField({ value }: AutoFieldProps): JSX_2;

export declare interface AutoFieldProps {
    value: any;
}

export declare function Badge({ children, badgeRef, level, }: BadgeInterface): JSX_2;
...
export declare function Bug(): JSX_2;
...
export declare function ButtonSelect<T extends string | number>({ options, value, onChange, main, disabled, ...props }: ButtonSelectProps<T>): JSX_2;
...
export declare function Clear(): JSX_2;

export declare function Close(): JSX_2;
...
export declare function Colorize(): JSX_2;

export declare function compareVersions(v1: string, v2: string): number;

export declare function ControlledExpandable({ title, children, open, setOpen, }: ControlledExpandableProps): JSX_2;
...
export declare function ElementSwitch<T extends string>({ value, cases, }: ElementSwitchProps<T>): JSX_2;
...
export declare function Expandable({ title, children, open }: ExpandableProps): JSX_2;
...
export declare function FastForward(): JSX_2;

export declare function FastRewind(): JSX_2;
...
export declare function Fullscreen(): JSX_2;
...
export declare function Grid(): JSX_2;
...
export declare function HourglassBottom(): JSX_2;

export declare function IconButton({ children, onClick, title, className, disabled, }: IconButtonProps): JSX_2;
...
export declare function IconCheckbox({ children, titleOn, titleOff, onChange, checked, main, }: IconCheckboxProps): JSX_2;
...
export declare function Locate(): JSX_2;
...
export declare function Movie(): JSX_2;

export declare function Navigation(): JSX_2;

export declare function NumberField({ value }: NumberFieldProps): JSX_2;
...
export declare function OpenInNew(): JSX_2;
...
export declare function Pause(): JSX_2;

export declare function PhotoCamera(): JSX_2;

export declare function Pill({ children, checked, onChange, titleOn, titleOff, }: PillProps): JSX_2;
...
export declare function PlayArrow(): JSX_2;
...
export declare function Recenter(): JSX_2;

export declare function Repeat(): JSX_2;

export declare function ResizeableLayout({ id, children: [start, end], vertical, offset, hidden, }: ResizeableLayoutProps): JSX_2;
...
export declare function Revideo(): JSX_2;

export declare function Schedule(): JSX_2;

export declare function School(): JSX_2;

export declare function Science(): JSX_2;

export declare function Select<T>({ options, value, onChange, title, main, disabled, className, }: SelectProps<T>): JSX_2;
...
export declare function Settings(): JSX_2;
...
export declare function SkipNext(): JSX_2;

export declare function SkipPrevious(): JSX_2;

export declare function Space(): JSX_2.Element;

export declare function SpacingField({ value }: SpacingFieldProps): JSX_2;
...
export declare function Tune(): JSX_2;

export declare function UnfoldMore(): JSX_2;

export declare function UnknownField({ value }: UnknownFieldProps): JSX_2;
...
export declare function Vector2Field({ value }: Vector2FieldProps): JSX_2;

export declare interface Vector2FieldProps {
    value: Vector2;
}

export declare function Videocam(): JSX_2;

export declare function VideoSettings(): JSX_2;
...
export declare function VolumeOff(): JSX_2;

export declare function VolumeOn(): JSX_2;

export declare function Warning(): JSX_2;
