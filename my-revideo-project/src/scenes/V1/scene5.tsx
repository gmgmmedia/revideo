 ...
 * Duration: 20:00 - 28:00 (8 seconds)
...
export default makeScene2D('scene5', function* (view) {
  ...
  view.add(
    <>
      ...
      <Node ref={envelopeGroup} x={-100} y={-220} scale={0} opacity={0}>
        ...
        {/* Target list inside (dotted lines + labels) */}
  ...
  // --- Beat 21 (25:10) - Transition to parallel flow finale ---
  yield* all(
